...
#		res.append((eListboxPythonMultiContent.TYPE_TEXT, 50, 1, 810, 35, 0, RT_HALIGN_LEFT, name))
#	else:
...
#	if config.skin.xres.value == 1920:
#		res.append((eListboxPythonMultiContent.TYPE_TEXT, 55, 1, 705, 35, 0, RT_HALIGN_LEFT, name))
#	else:
	...
	if png is not None:
#		if config.skin.xres.value == 1920:
#			res.append((eListboxPythonMultiContent.TYPE_PIXMAP_ALPHATEST, 30, 5, 20, 20, png))
#		else:
