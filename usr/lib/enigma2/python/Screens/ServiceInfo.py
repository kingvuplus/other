...
def ServiceInfoListEntry(a, b, valueType=TYPE_TEXT, param=4):
	...
	if config.skin.xres.value == 1920:
		return [
			...
			(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 300, 35, 0, RT_HALIGN_LEFT, ""),
			(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 300, 35, 0, RT_HALIGN_LEFT, a),
			(eListboxPythonMultiContent.TYPE_TEXT, 280, 0, 450, 35, 0, RT_HALIGN_LEFT, b)
			]
	else:
	       return [
		        #PyObject *type, *px, *py, *pwidth, *pheight, *pfnt, *pstring, *pflags;
